...
public class CreateNodeSyncAuth implements Watcher {
    ...
    private void doSomething() {
        try {
            ...
            ACL aclDigest = new ACL(Perms.READ | Perms.WRITE, new Id("digest", DigestAuthenticationProvider.generateDigest("wither:123456")));
            ...
            ArrayList<ACL> creatorAllAcl = ZooDefs.Ids.CREATOR_ALL_ACL;// 使用zookeeper.addAuthInfo进行认证
            ...
            String path = zookeeper.create("/node_4", "123".getBytes(), aclList, CreateMode.PERSISTENT);
